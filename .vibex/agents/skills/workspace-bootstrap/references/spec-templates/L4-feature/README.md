...
产品视角下，L4 对应从 L3 分区控件触发的**一条完整用户能力**（含验收）。权威措辞与拆分规则见 [`../L0-meta-convention/L0-layer-contract-template.yaml`](../L0-meta-convention/L0-layer-contract-template.yaml) 内 `content.product_layering_governance.l4_feature_click_through`、`split_heuristic`。
