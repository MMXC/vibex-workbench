...
# Allow CLI override: specpilot start → spawns with python dc/server.py --port N
_PORT_ARG = None
...
PORT = _PORT_ARG or int(os.environ.get("SPECPILOT_DC_PORT", "7890"))
WORKSPACE = os.environ.get("SPECPILOT_WORKSPACE", ".")  # overridden at init
...
if __name__ == "__main__":
    print(f"[DataCenter] listening on 127.0.0.1:{PORT}")
    DataCenterServer(port=PORT, workspace=WORKSPACE).serve_forever()
