...
产品视角下，L3 对应打开应用后可见的**主模块 / 主分区（壳）**。权威措辞见 [`../L0-meta-convention/L0-layer-contract-template.yaml`](../L0-meta-convention/L0-layer-contract-template.yaml) 内 `content.product_layering_governance.l3_module_ui_shell`。
